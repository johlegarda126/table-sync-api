...
## Contexto
El archivo llamado `specs/mongodb.spec.md` contiene la especificación de la funcionalidad a implementar. 
...
4. **Preparar a Git:**
  ...
  - Actualiza cambios en la rama `feat/table`.
5. **Escribir código:**
  - Escribir el código mínimo necesario para cumplir el plan.

## Checklist de salida
- [ ] Commit de actualización de la rama`feat/table` con la implementación.
- [ ] Modificar o crear nuevos archivos de código según lo especificado en el plan.