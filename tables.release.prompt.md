...
## Contexto
El branch actual `feat/table` fue implementado de `specs/tables.spec.md`.

## Pasos a seguir
1. **Revisión de código:**
  - Escribe los test e2e para asegurar los criterios de aceptación de `specs/tables.spec.md`
