...
## Contexto
+ Un endpoint para gestionar la reservación de mesas de restaurantes.
+ Cada mesa tiene:
  - id del restaurante al que pertenece
  - número de mesa
  - capacidad (1 a 11 personas)
  - estado (disponible, reservada, ocupada)
  - tipo de mesa (interior, exterior, privada, familiar)

Solicitar cualquier contexto adicional si es necesario.

## Plantilla de especificación
Siga esta plantilla para escribir el archivo de especificaciones en el archivo: `specs/tables.spec.md`
...
## Checklist de salida
- [ ] La salida debe ser un archivo markdown llamado `specs/tables.spec.md`
